package leetcode.leetcode0001_1000.leetcode901_1000.leetcode0911_0920;
...
public class LeetCode0913 {
    ...
    public static void main(String[] args) {
        LeetCode0913 game = new LeetCode0913();
//
//        int[][] graph1 = {{2, 5}, {3}, {0, 4, 5}, {1, 4, 5}, {2, 3}, {0, 2, 3}};
//        System.out.println(game.catMouseGame(graph1)); // Output: 0 (Draw)
//
//        int[][] graph2 = {{1, 3}, {0}, {3}, {0, 2}};
//        System.out.println(game.catMouseGame(graph2)); // Output: 1 (Mouse wins)

        int[][] graph3 = {{2,3},{3,4},{0,4},{0,1},{1,2}};
        System.out.println(game.catMouseGame(graph3)); // Output: 1 (
    }
